...
class TestPingDetails(BaseTest):

    def test_ping_details(self):
        ...
        res = client.get('/api/ping/details/%s/' % ping.id)
        ...
        for i in range(0, 50):
            ...
            if i % 3 == 0:
                ...
                self.assertEqual(r['text'], 'Many pings failed on this day')
